...
for shot in gather-running gather-completed inventory-32-oak-logs already-satisfied stopped plan-first-task plan-complete screen-agent screen-chat screen-build screen-settings; do
